...
@Component({
  selector: 'app-postagem-del',
  templateUrl: './postagem-del.component.html',
  styleUrls: ['./postagem-del.component.css']
})
export class PostagemDelComponent implements OnInit {
